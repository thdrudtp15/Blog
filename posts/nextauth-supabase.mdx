...
-   Supabase 프로젝트 URL 확인 방법:
    ![supabase-url](/images/nextauth-supabase/url.png)
-   Secret Key 확인 방법:
    ![supabase-secret-key](/images/nextauth-supabase/secret.png)
...
-   Exposed schemas에 `next_auth` 추가  
    ![exposed-schema](/images/nextauth-supabase/exposed.png)
